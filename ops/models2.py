...
class TSN(nn.Module):
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            # 读取下载好的resnet
            # base_model_local = torch.load('./data/mode/torch/hub/checkpoints/resnet50-0676ba61.pth',
            #                               map_location=torch.device('cpu'))
            # self.base_model = torchvision.models.resnet.resnet50()
            # self.base_model.load_state_dict(base_model_local)
